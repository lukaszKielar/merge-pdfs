...
while answer:
    ...
    pdfs = filedialog.askopenfilenames(initialdir=initial_dir, title="Select files",
    ...
    if len(pdfs) > 0:
        ...
        while out_pdf == "":
            out_pdf = filedialog.asksaveasfilename(initialdir=save_dir, defaultextension=".pdf",
